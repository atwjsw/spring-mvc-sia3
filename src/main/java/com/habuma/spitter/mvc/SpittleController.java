...
//    model.addAttribute(spitterService.RecentSpittles(20));
  ...
  public String createSpittleFromForm(@Valid Spittle spittle,
    ...
    System.out.println("createSpittleFromForm");
    if(result.hasErrors()) {
...
//    spitterService.saveSpittle(spittle);
  ...
  @RequestMapping(method=RequestMethod.POST, headers="Accept=application/json") //<co id="co_handlePOST"/>
  @ResponseStatus(HttpStatus.CREATED) // <co id="co_createdResponse" />
  public @ResponseBody
//  Spittle createSpittle(@Valid Spittle spittle,
  Spittle createSpittle(@RequestBody Spittle spittle,
//                        BindingResult result, HttpServletResponse response)
                        HttpServletResponse response)
                        throws BindException {
    System.out.println("createSpittle");
//    if(result.hasErrors()) {
...
//  @RequestMapping(value="/{id}", method=RequestMethod.GET)
  ...
  public @ResponseBody Spittle getSpittleRest(@PathVariable("id") long id) {
    System.out.println("in getSpittleRest");
    Spittle spittle = new Spittle();
    spittle.setId(1L);
    spittle.setText("restful spittle");
    return spittle;
  }
  ...
  @RequestMapping(value="/{id}", method=RequestMethod.PUT)
  @ResponseStatus(HttpStatus.NO_CONTENT)
  public void putSpittle(@PathVariable("id") long id, @Valid Spittle spittle, BindingResult result) throws BindException {
  //    spitterService.saveSpittle(spittle);
  }
